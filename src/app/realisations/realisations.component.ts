  ...
  ngOnInit(): void {
    this.realisations.push(
      ...
      new Project(
        ...
        '/assets/img/guillaume-astruc-photography.jpg',
      ...
      new Project(
        ...
        'WordPress',
        '/assets/img/prune-manciet-osteopathe.jpg',
      ...
      //   'WordPress',
      //   '/assets/img/serwan-messe-etiopathe.jpg',
